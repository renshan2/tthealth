...
export default class AppKeyCard extends React.Component {
  ...
  render() {
     ...
     const { onPress, wallet } = this.props;
      ...
      //debugger;
     console.log('WalletCard render item.name: ', item.name);
      //    console.log('WalletCard render item.description: ', item.description);
     console.log('WalletCard render total: ', total);
